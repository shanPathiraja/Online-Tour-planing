...
<?php include('models/orderModel.php');?>

			<div class="col-xl-10">
				<h3>View Orders</h3>
				</br></br></br></br>
				<table class="table" width="100%">
					<caption>View Orders</caption>
            <thead>
            <tr>
                <th scope="col">#</th>
                ...
                <th scope="col">number of pesons</th>
...
FROM orders";
            ...
            while($row = mysqli_fetch_row($res)){
                ...
                <tr>
                    ...
                    <td scope="row"><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#orderModel<?php echo($row[0]); ?>">
  View Order
</button><button class="btn btn-danger"id="delbtn"value="<?php echo($row[0]); ?>" onClick="delReq(this.value)">Remove</button></td>
	...
	<div class="row">
        ...
        <script type="text/javascript">
            function delReq(id){
                ...
                if(r == true) {
                    $.ajax({
                        url: "functions/delOrder.php", //the page containing php script
                        type: "POST",
                        data: {delid: id},
                        beforeSend: function () {
                            $('#right').html('checking');
